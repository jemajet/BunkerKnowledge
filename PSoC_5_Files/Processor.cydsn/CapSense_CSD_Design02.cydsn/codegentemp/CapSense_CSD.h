...
void CapSense_CSD_Init(void) CYREENTRANT;
void CapSense_CSD_Enable(void) CYREENTRANT;
void CapSense_CSD_Start(void) ;
void CapSense_CSD_Stop(void) CYREENTRANT;
void CapSense_CSD_SaveConfig(void) CYREENTRANT;
void CapSense_CSD_Sleep(void) ;
void CapSense_CSD_RestoreConfig(void) CYREENTRANT;
void CapSense_CSD_Wakeup(void) CYREENTRANT;
uint8 CapSense_CSD_IsBusy(void) CYREENTRANT;
...
uint16 CapSense_CSD_ReadSensorRaw(uint8 sensor) CYREENTRANT;
void CapSense_CSD_ClearSensors(void) CYREENTRANT;
