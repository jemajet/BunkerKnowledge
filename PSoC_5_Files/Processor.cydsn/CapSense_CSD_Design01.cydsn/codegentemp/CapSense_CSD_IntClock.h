...
#define CapSense_CSD_IntClock_SetDivider(clkDivider)         CapSense_CSD_IntClock_SetDividerRegister(clkDivider, 1u)
#define CapSense_CSD_IntClock_SetDividerValue(clkDivider)    CapSense_CSD_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define CapSense_CSD_IntClock_SetPhaseValue(clkPhase)        CapSense_CSD_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(CapSense_CSD_IntClock__CFG3) */
